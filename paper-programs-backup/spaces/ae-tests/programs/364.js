// Circle location, radius, color - Copy
...
(async () => {
  ...
  const onProgramMarkersChangedPosition = ( programNumber, positionPoints, programPoints, scratchpad, sharedData, currentMarkers ) => {
    ...
    if (firstMarker){
      ...
      phet.paperLand.console.log('firstMarkerX is', firstMarkerValueX);
      phet.paperLand.console.log('firstMarkerY is', firstMarkerValueY);
    if ( scratchpad.testCircle ){
    sharedData.scene.removeChild( scratchpad.testCircle );
    }
    ...
    // change this to situate the circle within the paper
    // find width and height of paper
    //const paperWidth = positionPoints[1].x + positionPoints[0].x;
    //const paperHeight = positionPoints[1].y + positionPoints[0].y;
    scratchpad.circleLocationX = firstMarkerValueX;
    scratchpad.circleLocationY = firstMarkerValueY;




    //scratchpad.circleCenterX = firstMarkerValueX;
    //scratchpad.circleCenterY = firstMarkerValueY;
    
    
    scratchpad.testCircle = new phet.scenery.Circle( scratchpad.circleRadius, {x:scratchpad.circleLocationX, y:scratchpad.circleLocationY,
