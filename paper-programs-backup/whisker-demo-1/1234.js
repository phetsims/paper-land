...
(async () => {
  ...
  const onProgramAdded = ( paperProgramNumber, scratchpad, sharedData ) => {
    ...
    elementConstructor => {
      ...
      phet.paperLand.addModelComponent( 'element3', connectionElement );
    ...
    () => {
      ...
      const connectionElement = phet.paperLand.getModelComponent( 'element3' );
      if ( connectionElement ) {
        ...
        phet.paperLand.removeModelComponent( 'element3' );
        phet.paperLand.removeProgramData( 'element3' );
      }
    } );
  };
  ...
  const onProgramRemoved = ( paperProgramNumber, scratchpad, sharedData ) => {
    ...
    const element = phet.paperLand.getModelComponent( 'element3' );
    if ( element ) {
  ...
  const onProgramAdjacent = ( programNumber, otherProgramNumber, direction, scratchpad, sharedData ) => {
    ...
    if ( otherConnectionElement ) {
      ...
      otherConnectionElement.addChild( phet.paperLand.getModelComponent( 'element3' ) );
    }
  };
  ...
  const onProgramSeparated = ( programNumber, otherProgramNumber, direction, scratchpad, sharedData ) => {
    ...
    const otherConnectionElement = phet.paperLand.getProgramData( otherProgramNumber, 'connectionElement' );
    if ( otherConnectionElement ) {
      const thisElement = phet.paperLand.getModelComponent( 'element3' );
