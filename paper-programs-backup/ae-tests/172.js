...
// Program Description: derived from Line Drawing
...
// Find the initial paper size, and the initial radius of the circle.
  ...
  const onProgramMarkersChangedPosition = ( programNumber, programPoints, scratchpad, sharedData, currentMarkers ) => {
    ...
    if ( model.has( 'dashedlineColorProperty' ) ) {
      ...
      scratchpad.dashedlineColor = model.get( 'dashedlineColorProperty' );
    ...
    scratchpad.testLine = new phet.scenery.Line( scratchpad.lineEndpoint1x, scratchpad.lineEndpoint1y, scratchpad.lineEndpoint2x, scratchpad.lineEndpoint2y, {stroke: scratchpad.dashedlineColor, lineWidth:5, lineCap:'round',
    lineDash:[10,10]} );
