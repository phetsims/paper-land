...
(async () => {
  ...
  const onProgramAdded = ( paperProgramNumber, scratchpad, sharedData ) => {
    // Voicing responses
    const voicingNameResponse = 'Toggle me!';
    const voicingHintResponse = 'Help me.';
    ...
    scratchpad.linkID = phet.paperLand.addModelPropertyLink('checkboxBooleanProperty', checked => {
        ...
        const objectResponse = checked ? 'I am checked.' : 'I am not checked.'
        const contextResponse = checked ? 'Describe what happened!' : 'Described what happened!'
